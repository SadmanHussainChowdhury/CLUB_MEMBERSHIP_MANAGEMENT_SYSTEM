...
$store_id=urlencode("robot64e75e9c52af1");
$store_passwd=urlencode("robot64e75e9c52af1@ssl");
...
if($code == 200 && !( curl_errno($handle)))
{
    ...
    echo "Your Payment Successful</br>";
    echo "Your Payment Amount : " .$amount. "</br>";
    echo "CMMS will get Amount : " .$store_amount. "</br>";
    echo "Your Payment Amount : " .$card_type. "</br>";
...
?>
 ...
 <a class="pay_btn" href="register_form.php">Registration</a>
</div>
