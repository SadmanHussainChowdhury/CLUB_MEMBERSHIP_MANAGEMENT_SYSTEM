...
<section class="singlepost">
    <div class="container singlepost__container">
        ...
        <form action="admin_profile_post.php" method="POST" enctype="multipart/form-data">
...
<div>
<form action="admin_profile_pic_post.php" method="POST" enctype="multipart/form-data">
